    ...
    <div class="main-content">
        ...
        <div class="big-btn">
            <div class="btn btn-active ">
                <div class="btn-img"><img src="{{ url('assets/svg/wt-wallet.svg') }}" alt=""></div> DEPOSIT
            </div>
            <div class="btn btn-active ">
                <div class="btn-img"><img src="{{ url('assets/svg/wt-withdraw.svg') }}" alt=""> </div>WITHDRAWAL
            </div>
        </div>
        ...
        <div class="product-container">
            <div class="product-box">
                <div class="prd-img">
                    <img src="{{ url('assets/svg/product.svg') }}" alt="">
                </div>
